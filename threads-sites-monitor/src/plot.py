...
def plot_cpu_comparison(cpu_usage_mono, cpu_usage_multi, mono_time, multi_time):
...
def plot_memory_usage(memory_usage_mono, memory_usage_multi, mono_time, multi_time):
...
def plot_all(results):
    ...
    plot_cpu_comparison(results["mono"]["cpu"], results["multi"]["cpu"], results["mono"]["time"], results["multi"]["time"])
    plot_memory_usage(results["mono"]["mem"], results["multi"]["mem"], results["mono"]["time"], results["multi"]["time"])
